...
def register_user():
    ...
    if username and password:
        ...
        messagebox.showerror('unsuccessful','Please fill all fields.')
...
def login_page():
    ...
    tk.Button(root, text="Login",font=('comic sans', '10', 'normal'),width='10',bg='lightblue', 
              command=login_user).place(x=700, y=450)
    tk.Button(root, text="Sign Up",font=('comic sans', '10', 'underline', )
              ,width='10',bg='lightblue', command=signup_page).place(x=800, y=600)
...
def signup_page():
    ...
    tk.Button(root, text="Sign Up", font=('comic sans', '10', 'normal')
              ,width='10',bg='skyblue',command=register_user).place(x=680, y=450)
    tk.Button(root, text="Return to Login", font=('comic sans', '10', 'normal')
              ,width='20',bg='skyblue', command=login_page).place(x=650, y=500)
