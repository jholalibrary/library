...
class AddMember(Toplevel):
  def __init__(self):
    ...
    heading = Label(self.topFrame,text=' Add New Member ',font='arial 22 bold',fg='#003f8a',bg='white')
    ...
    ##Buttonn---------
    btn=Button(self.bottomFrame,text='Add New Member',command=self.addMember)
